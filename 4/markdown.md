...
**別途サービスの利用料が発生する場合やセキュリティ面で注意する必要がある場合**

![](../.gitbook/assets/warn-ex1.png)

**教材の対応OSや対応バージョンを強調したい場合**
...
想定される補足の使用タイミングとしては、受講生からの質問で説明をもう少し付け加えた方がいいなと思った時や、複数の実装パターンがあって受講生が疑問を持ちそうな部分を先回りして解決したい時などが考えられます。
